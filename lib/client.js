...
.drw-segmented-item{appearance:none;border:none;background:none;cursor:pointer;padding:4px 12px;font-size:12px;font-weight:500;border-radius:6px;color:var(--dsw-alias-label-secondary);transition:all .15s ease}
...
.drw-stat-val{font-size:15px;font-weight:700;color:var(--dsw-alias-label-primary)}
...
.drw-browser-modal{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;background:var(--dsw-alias-bg-layer-2);padding:12px;display:flex;flex-direction:column;gap:8px;max-height:260px}
.drw-browser-list{overflow-y:auto;display:flex;flex-direction:column;gap:2px;max-height:180px;padding-right:4px}
...
.drw-browser-item:hover{background:var(--dsw-alias-bg-layer-3)}
    ...
    const en = {
      ...
      fRemotePathHint: '(Optional now, can be chosen later while working)',
      btnBrowse: '📁 Browse Remote...',
      btnSelectThis: 'Select Current Directory',
    ...
    const ru = {
      ...
      fAuthKey: 'SSH-ключ',
      fAuthPass: 'Пароль',
      fKeyPath: 'Путь к ключу',
      fPassphrase: 'Кодовая фраза ключа (если есть)',
      fPassword: 'Пароль учетной записи',
      fRemotePath: 'Удалённая папка проекта',
      fRemotePathHint: '(Не обязательно сейчас — можно выбрать позже при работе)',
      btnBrowse: '📁 Выбрать на сервере…',
      btnSelectThis: 'Выбрать эту папку',
        ...
        React.createElement(
          ...
          editing
            ? React.createElement(
                ...
                // Remote Project Directory (Optional, with live server browse)
                React.createElement(
                  'div',
                  ...
                  React.createElement(
                    ...
                    React.createElement('span', { style: { fontSize: '11px', color: 'var(--dsw-alias-label-tertiary)' } }, t('fRemotePathHint'))
                  ),
                  React.createElement(
                    'div',
                    ...
                    React.createElement('input', {
                      className: 'drw-input',
                      placeholder: '/var/www/my-project or ~/projects/app (can leave empty for now)',
                ...
                // Remote Directory Browser Modal/Inline Tree
                browserOpen
                  ? React.createElement(
                      'div',
                ...
                React.createElement(
                  ...
                  profiles.map((p) => {
                    ...
                    return React.createElement(
                      ...
                      React.createElement('td', null, p.remoteWorkspace || '— (not set)'),
                      React.createElement(
                        'td',
          ...
          ? React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  'div',
                  { className: 'drw-stat-box' },
                  React.createElement('div', { className: 'drw-stat-val' }, activeProfile.remoteWorkspace || '— (select during work)'),
                  React.createElement('div', { className: 'drw-stat-lbl' }, 'Remote Workspace Directory')
                ),
                React.createElement(
                  'div',
                  { className: 'drw-stat-box' },
                  React.createElement('div', { className: 'drw-stat-val' }, activeProfile.authType === 'password' ? 'Password Auth' : 'SSH Key Auth'),
