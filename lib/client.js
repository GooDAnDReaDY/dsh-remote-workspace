...
[data-dsh-frame][data-sidebar-collapsed] .drw-entry-label{display:none}
    ...
    const en = {
      ...
      updaterTitle: 'Plugin update',
      currentVersion: 'Installed version',
      latestVersion: 'Latest on npm',
      ...
      restartRequired: 'The update is installed. Restart DSH to use it.',
      ...
      importAdded: 'Imported {count} hosts.',
      skipWildcard: 'pattern is not a single host',
      skipMatch: 'Match blocks are not imported',
      skipDuplicate: 'already imported',
      skipMissing: 'included file was not found',
      ...
      groupOnline: 'online, {latency} ms',
      groupOffline: 'offline: {err}',
      tabProfiles: 'Hosts',
      tabCluster: 'Cluster',
      tabFiles: 'Files',
      btnUpload: 'Upload',
      btnDownload: 'Download',
      transferProgress: '{name}: {percent}%',
      transferFailed: 'Transfer failed: {name}',
      transferCancel: 'Cancel',
      clusterTitle: 'Run on a group',
      clusterCommand: 'Command',
      clusterRun: 'Run',
      clusterRunning: 'Running...',
      clusterCount: '{count} hosts configured',
      clusterOk: 'ok',
      clusterFail: 'failed',
      fAuthAgent: 'SSH Agent',
      authPromptTitle: 'Sign-in code',
      authPromptCode: 'One-time code',
      authPromptSubmit: 'Continue',
      fAuthKeyShort: 'key',
      fAuthPassShort: 'pwd',
      fAuthAgentShort: 'agent',
      fAgentPath: 'Agent socket',
      fAgentPathHint: 'Empty uses SSH_AUTH_SOCK. Use pageant on Windows.',
      fJumpHosts: 'Jump hosts',
      fJumpHostsHint: 'Profile ids in order, separated by commas. The first host is the entry bastion.',
      fProxyCommand: 'Proxy command',
      fProxyCommandHint: 'OpenSSH ProxyCommand. Tokens: %h host, %p port, %r user, %n profile name.',
      fTerminalFont: 'Terminal font',
      fTerminalFontHint: 'Font family for the terminal. Leave empty to keep the default monospace stack.',
    ...
    const zh = {
      ...
      importAdded: '已导入 {count} 台主机。',
      skipWildcard: '通配主机不会导入',
      skipMatch: '不导入 Match 块',
      skipDuplicate: '已经导入',
      skipMissing: '找不到被包含的文件',
    ...
    updateFailed: '更新失败',
      ...
      fDescription: '说明',
      groupFlat: '平铺',
      groupEnvironment: '按环境',
      groupTag: '按标签',
      groupUngrouped: '未分组',
      testGroup: '测试本组',
      groupOnline: '在线，{latency} 毫秒',
      groupOffline: '离线：{err}',
      tabProfiles: '主机',
      tabCluster: '集群',
      tabFiles: '文件',
      ...
      btnDownload: '下载',
      transferProgress: '{name}：{percent}%',
      transferFailed: '传输失败：{name}',
      transferCancel: '取消',
      clusterTitle: '在一组主机上运行',
      clusterCommand: '命令',
      clusterRun: '运行',
      clusterRunning: '正在运行...',
      clusterCount: '已配置 {count} 台主机',
      clusterOk: '成功',
      clusterFail: '失败',
      fAuthAgent: 'SSH 代理',
      authPromptTitle: '登录验证码',
      authPromptCode: '一次性验证码',
      authPromptSubmit: '继续',
      fAuthKeyShort: '密钥',
      fAuthPassShort: '密码',
      fAuthAgentShort: '代理',
      fAgentPath: '代理套接字',
      fAgentPathHint: '留空则使用 SSH_AUTH_SOCK。Windows 上填写 pageant。',
      fJumpHosts: '跳板主机',
      fJumpHostsHint: '按经过顺序填写配置编号，用逗号分隔。第一台是入口堡垒机。',
      fProxyCommand: '代理命令',
      fProxyCommandHint: 'OpenSSH ProxyCommand。令牌：%h 主机，%p 端口，%r 用户，%n 配置名称。',
      fTerminalFont: '终端字体',
      fTerminalFontHint: '终端使用的字体族。留空则使用默认等宽字体。',
      fKeyPath: '私钥文件路径',
